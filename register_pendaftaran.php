...
// Submit
    if( isset($_POST["submit"]) ) {
       ...
       if ( register($_POST) > 0 ) {
           ...
           echo "
           <script>
                alert('Mohon Maaf, Registrasi Anda Tidak berhasil!');
                document.location.href = 'register_pendaftaran.php';
           </script>
           ";
       }
    }
  ...
  <body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link" href="register_pendaftaran.php">Registrasi</a>
                </div>
            </div>
            </div>
        </nav>
    ...
    <div class="card column">
      <div class="card-body">
        ...
        <center>
      <span><h5 class="card-title" style="padding:10px;">Form Registrasi Tim Produksi Eternal Audams</h5>
        </center>
      ...
      <ul style="list-style: none; padding: 10px;">
            ...
            <li style="padding: 10px;">
                <input class="form-control" type="text" placeholder="Motto" aria-label="default input example" name="Motto" id="Motto" required>
            </li>
            <li style="padding: 10px;">
                <input class="form-control" type="text" placeholder="Riwayat Organisasi" aria-label="default input example" name="Riwayat_Organisasi" id="Riwayat_Organisasi" required>
            </li>
            <li style="padding: 10px;">
                <input class="form-control" type="text" placeholder="Motivasi Bergabung" aria-label="default input example" name="Motivasi_Bergabung" id="Motivasi_Bergabung" required>
            </li>
            <li style="padding: 10px;">
                <input class="form-control" type="text" placeholder="Harapan" aria-label="default input example" name="Harapan" id="Harapan" required>
            </li>
            <li style="padding: 10px;">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked required>
                <label class="form-check-label" for="flexCheckChecked">
                Saya menyetujui untuk bergabung dengan Tim Produksi Eternal Audams dan siap untuk mengikuti kegiatan-kegiatan yang dilaksanakan.
                </label>
            </div>
            </li>
            <li style="padding: 10px;">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked required>
                <label class="form-check-label" for="flexCheckChecked">
                Saya telah membaca seluruh <a href="https://drive.google.com/file/d/1U9_6o-bhErCcTFHU_cBrNICDvRIyAuow/view?usp=sharing">syarat dan ketentuan
                </a>.
                </label>
            </div>
            </li>
        ...
        <div class="row">
          <div class="col-12 col-md">
            ...
            <ul class="list-unstyled text-small">
                <li><a class="link-secondary" href="register_anggota.php">Registrasi Ulang</a></li>
            </ul>
          </div>
