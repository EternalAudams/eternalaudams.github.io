...
function register($data) {
    ...
    $riwayatorganisasi = htmlspecialchars($data["Riwayat_Organisasi"]);  
    $motivasibergabung = htmlspecialchars($data["Motivasi_Bergabung"]);  
    $harapan = htmlspecialchars($data["Harapan"]);  


    // query insert data
    $query= "INSERT INTO eternal_audams_database_pendaftaran
            VALUES
        ('', '$email', '$namalengkap', '$namapanggilan', '$tempatlahir', '$tanggallahir',
        '$jeniskelamin', '$agama', '$alamat', '$kelas', '$nis', '$hobi', '$fotodiri', '$notelp',
        '$motto', '$riwayatorganisasi', '$motivasibergabung', '$harapan')
    ";
